...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'disputeDetail' => \App\Http\Middleware\DisputeDetail::class,
        'orderDetail' =>  \App\Http\Middleware\OrderDetail::class ,
        'checkUserStatus' =>  \App\Http\Middleware\CheckUserStatus::class ,
        'translate'  =>        \App\Http\Middleware\TranslateStaticWords::class,
    ];
}
