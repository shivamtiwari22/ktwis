        ...
        <div class="modal-content">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <p class="mt-3">If you delete the category <b>[<span id="warning-alert-modal-text"></span>]</b>. All of its sub-categories will be deleted.</p>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a aria-current="page">Category</a></li>
    </ol>
</nav>
    ...
    <table id="category_table" class="table table-striped dt-responsive nowrap w-100">
        <thead>
            <tr>
                ...
                <th>Parent Categories Structure </th>
                <th>Action</th>
            </tr>
        </thead>
    </table>
    ...
    $(function() {
        $.fn.tableload = function() {
            $('#category_table').dataTable({
                ...
                "ajax": {
                    url: "{{ route('admin.categories.list_render') }}",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
        ...
        $('body').on("click", ".deleteType", function(e) {
            ...
            $('#warning-alert-modal').on('click', '.confirm', function() {
                $.ajax({
                        url: "{{route('admin.categories.list_delete')}}",
                        type: 'POST',
                        data: fd,
                        dataType: "JSON",
                        contentType: false,
