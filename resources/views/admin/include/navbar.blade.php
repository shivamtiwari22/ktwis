...
<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg">
  ...
  <div class="dropdown-item noti-title">
      <h5 class="m-0">
          <span class="float-end">
              <a href="{{route('admin.allMarkAsRead')}}" class="text-dark">
  ...
  <!-- All-->
  <a href="{{route('admin.viewAll')}}" class="dropdown-item text-center text-primary notify-item notify-all">
      {{$count > 0 ?  'View All' : ''}}  
  </a>
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <span class="account-user-avatar">
                    ...
                    <img src="{{ asset('public/admin/profile_pic/' . Auth::guard('web')->user()->profile_pic) }}" alt="user-image" class="rounded-circle">
                    @else
