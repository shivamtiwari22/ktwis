        ...
        <form id="language_form">
            <div class="row">
                ...
                <div class="mb-3 col-lg-6">
                    ...
                    <input type="number" class="form-control" name="order" value="{{$language->order}}">
                </div>
            </div>
            <div class="row">
                ...
                <div class="mb-3 col-lg-4">
                    <label for="simpleinput" class="form-label">Flag <span class="fw-light">(png/jpg/svg)</sapn></label>
                        @if ($language->flag)
                        <span><img src="{{ url('public/admin/setting/language/flag/' . $language->flag) }}" alt="{{ $language->language }}" height="20px"></span>
                    @endif                
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="text" class="form-control" name="php_locale_code" value="{{$language->php_locale_code}}">
                </div>
            </div>
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" id="switch2" {{ $language->status == "1" ? 'checked' : '' }} data-switch="primary" value={{$language->status}} onclick="updateCheckboxValue(this)">
