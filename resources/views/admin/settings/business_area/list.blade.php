...
@section('main_content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a aria-current="page">Business Area</a></li>
        </ol>
    </nav>
    <div class="card mt-1 p-3">
        <div class="d-flex justify-content-end mb-2">
            <a href="{{ route('business_area.addnew') }}" class="btn btn-success">Add Business Area</a>
        </div>
...
@section('script')
        ...
        $(function() {
            $.fn.tableload = function() {
                $('#category_table').dataTable({
                    ...
                    "ajax": {
                        url: "{{ route('business.list.render') }}",
                        "type": "POST",
                        "data": function(d) {
                            d._token = "{{ csrf_token() }}";
                        },
    ...
    if (currentValue === '1') {
        ...
        $('#switch2_' + id).prop('checked', false); 
            ...
            $.ajax({
                url: "{{ route('business.stausChange') }}",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
