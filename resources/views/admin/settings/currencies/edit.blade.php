...
<nav aria-label="breadcrumb">
    ...
    <div class="card p-4 mt-4">
        ...
        <form id="currency_form">
            ...
            <div class="row">
                <div class="mb-3 col-lg-6">
                    <label for="simpleinput" class="form-label">Currency Flag (PNG,JPG,JPENG,2MB)</label><span class="mx-2"><img src="{{ url('public/admin/setting/currency/currency_flag/' . $currency->currency_flag) }}" alt="{{ $currency->currency_flag }}" width="40px"></span>
