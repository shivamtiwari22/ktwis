...
@section('main_content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.appereance.content') }}">Dynamic Content</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add Content</li>
        </ol>
    </nav>
    <h2>Add <span class="badge badge-success-lighten">Content</span></h2>
    <hr>
    <form id="add_blogs_form">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <select name="type" id="type" class="form-select" disabled>
                 ...
                 <option value="faq" {{$data->type == 'faq' ? 'selected':''}} >Faq</option>
                </select>
            </div>
            <div class="col-sm-8">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <input type="text" id="slug" name="slug" readonly class="form-control" value="{{$data->slug}}">
            </div>
            <div class="col-sm-4">
        ...
        <div>
            <label for="meta_description">Og Tags:</label><br>
         
            <input type="text"  name="ogtag" class="form-control" value="{{$data->ogtag}}">
            <span id="tag-input1-error" class="error"></span>
        </div><br>
        <div>
            <label for="">Schema Markup:</label>
            <textarea id="" name="schema_markup" class="form-control" placeholder="Enter your text here...">{{$data->schema_markup}}</textarea>
        </div><br>

        <div>
            <label for="excerpt">Keywords:</label>
            <textarea id="" name="keywords" class="form-control" placeholder="Enter your text here...">{{$data->keywords}}</textarea>
        </div><br>
        ...
        $(function() {
            $(document).on('submit', '#add_blogs_form', function(e) {
                ...
                if (validateForm_edit()) {
                    $.ajax({
                        url: "{{ route('admin.appereance.updateContent') }}",
                        method: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
