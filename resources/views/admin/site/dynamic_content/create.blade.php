...
@section('main_content')
    ...
    <form id="add_blogs_form">
        ...
        <div>
            ...
            <input type="text" id="tag-input1" name="ogtag" class="form-control">
            <span id="tag-input1-error" class="error"></span>
        </div><br>
        <div>
            <label for="">Schema Markup:</label>
            <textarea id="" name="schema_markup" class="form-control" placeholder="Enter your text here..."></textarea>
        </div><br>

        <div>
            <label for="excerpt">Keywords:</label>
            <textarea id="" name="keywords" class="form-control" placeholder="Enter your text here..."></textarea>
        </div><br>
        ...
        $(function() {
            $(document).on('submit', '#add_blogs_form', function(e) {
                ...
                if (validateForm_edit()) {
                    $.ajax({
                        url: "{{ route('admin.appereance.postContent') }}",
                        method: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
