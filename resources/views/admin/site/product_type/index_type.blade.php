        ...
        <div class="modal-content">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <p class="mt-3">Are You Sure to Delete this Vendor Product </p>
...
<div style="display: flex; justify-content: space-between; align-items: flex-end;">
    ...
    <a href="{{route('admin.producttype.create')}}"><button type="button" class="btn btn-primary">Add Product Type</button></a>
</div>
<hr>
    ...
    $(function() {
        $.fn.tableload = function() {
            $('#page_appereance').dataTable({
                ...
                "ajax": {
                    url: "{{ route('admin.producttype.list_product_type') }}",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
        ...
        $('body').on("click", ".deleteproducttype", function(e) {
            var id = $(this).data('id');
            ...
            $('#warning-alert-modal').on('click', '.confirm', function() {
                $.ajax({
                        url: "{{route('admin.producttype.deleteproducttype')}}",
                        type: 'POST',
                        data: fd,
                        dataType: "JSON",
                        contentType: false,
