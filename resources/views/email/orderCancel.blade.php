...
<body>
    <div style="margin: 0; padding: 0;  background-color:#d9d6d0;">
        ...
        font-size:16px;">Subject Line: Order Cancel</p> --}}
        </div>
...
<p style="
        ...
        ">{{$data['user']->name}},</p>
             ...
             font: bold;
            margin-top: 18px;
            font-size:20px;">Your order id  #{{$data['order']->order_number}},   as per your request is<br>
                    cancelled on {{date('D, j M')}}
                </p>
            ...
            margin-top: 20px;
            font-size: 16px;
        "> This order has been cancelled as
                    per your request. we look forward
        ...
        cursor: pointer;
        border-radius:5px;">Order Details
                </button>
            </div>
        </div>
