    ...
    <div style="padding-top:20px; background-color: #fff;">
        ...
        ">{{$data['user']->name}},</p>
            <p style="
             font: bold;
            margin-top: 20px;
            font-size:20px;">Congratulations , Your order 

                <br>Is Full Filled on {{date('D, j M')}}"  with order Id {{$data['order']->order_number}}
            </p>
            ...
            margin-top: 20px;
            font-size: 16px;
        "> We are thrilled to inform you that your recent order has been successfully submitted and fulfilled! Our team has worked diligently to ensure a swift processing of your request.</p>
