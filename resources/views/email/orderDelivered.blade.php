...
<body>
    <div style="margin: 0; padding: 0;  background-color:#d9d6d0;">
        ...
        <div style="padding-top:20px; background-color: #fff;">
            <!-- <p style="
        font-size:16px;">Subject Line:Order Delivered</p> -->
        </div>
        ...
        ">{{$data['user']->name}},</p>
             ...
             font: bold;
            margin-top: 20px;
            font-size:20px;">we have delivered your 
                    order on {{date('D, j M')}}   With OrderID {{$data['order']->order_number}}. 
            ...
            margin-top: 20px;
            font-size: 16px;
        "> hope your bag of joy brought a
                    smile to your face. tell us about
        ...
        cursor: pointer;
        border-radius:5px;">Give Feedback
                </button>
            </div>
        </div> --}}
