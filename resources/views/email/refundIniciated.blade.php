...
<div style="margin: 0; padding: 0;  background-color:#d9d6d0;">
    ...
    <div style="padding-top:20px; background-color: #fff;">
        ...
        font-size:16px;">Subject Line:Refund Initiated</p> --}}
    </div>
    ...
    <div style="padding-top:20px; background-color: #fff;">
        ...
        ">{{$data['user']->name}},</p>
            <p style="
             font: bold;
            margin-top: 20px;
            font-size:20px;">we have initiated you<br>
refund  of amount {{$data['dispute']->refund_amount}}
            </p>
            ...
            margin-top: 20px;
            font-size: 16px;
        "> we have successfully completed your
return process and initiated your refund
on {{date('D, j M')}} with order id {{$data['order']->order_number}}</p>
        ...
        cursor: pointer;
        border-radius:5px;">View Return  Details
            </button>
        </div> --}}
    </div>
