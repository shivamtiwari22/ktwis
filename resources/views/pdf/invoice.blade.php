    ...
    <section class="clothing_invoice">
        <div class="container">
            <div class="invoice_heading">
                <h1>{{ $order_item[0]->product->categories[0]->category_name ?? null }}  Invoice</h1>
            ...
            <div class="cloth_pro">
                <h2 class="cloth_pro_head">{{ $order_item[0]->product->categories[0]->category_name ?? null }}  Products</h2>
