<div class="leftside-menu">
    ...
    <!-- LOGO -->
    <a href="{{route('vendor.dashboard')}}" class="logo text-center logo-light">
        <span class="logo-lg">
             <img src="{{ asset('public/assets/images/asset_9.png') }}" alt="" height="16"> 
            {{-- <label for="">GSpark</label> --}}
        </span>
        <span class="logo-sm">
            <img src="{{ asset('public/assets/images/asset_9.png') }}" alt="" height="16"> 
            {{-- <label for="">GSpark</label> --}}
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar="">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="{{route('vendor.order.index')}}" class="side-nav-link">  <i class="fa fa-cart-plus f-size" ></i>    <span class="badge bg-success float-end">{{$orderCount}}</span>  <span> {{ __('messages.Orders')  }}</span></a>
            </li>
            <li class="side-nav-item">
                <a href="{{ route('vendor.carts.index') }}" class="side-nav-link">  <i class="fa fa-cart-plus f-size"></i>     <span class="badge bg-success float-end">{{$cartCount}}</span>  <span>{{ __('messages.Carts')  }} </span></a>
            </li>
            <li class="side-nav-item">
                <a href="{{ route('vendor.wishlist.index') }}" class="side-nav-link">  <i class="fa fa-heart f-size"></i>    <span class="badge bg-success float-end">{{$wishlistCount}}</span>  <span> {{ __('messages.Wishlist')  }} </span></a>
            </li>
            

            <li class="side-nav-item">
                <a href="{{route('vendor.cancel')}}" class="side-nav-link">  <i class="fa fa-ban f-size"></i>    <span class="badge bg-success float-end">{{$cancelCount}}</span>  <span> {{__('messages.cancellation')}} </span></a>
            </li>

            <li class="side-nav-item">
                <a href="{{route('vendor.customer.index')}}" class="side-nav-link">  <i class="uil-user f-size"></i>  <span> {{__('messages.customer')}}</span> </a>
            </li>
            ...
            <li class="side-nav-item">
                <a href="{{route('vendor.message.message_index') }}" class="side-nav-link">
                    <i class="uil-comment-alt-message"></i>    <span class="badge bg-success float-end">{{$messagesCount}}</span>
            ...
            <li class="side-nav-item">
                <a href="{{ route('vendor.disputes.index') }}" class="side-nav-link">
                    <i class="uil-tag-alt"></i>    <span class="badge bg-success float-end">{{$disputeCount}}</span>
            ...
            <li class="side-nav-item">
                <a href="{{ route('vendor.reviews.index') }}" class="side-nav-link">
                    <i class="uil-eye"></i>    <span class="badge bg-success float-end">{{$reviewsCount}}</span>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarreports">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                            <a href="{{route('vendor.payoutDetail')}}">  {{ __('messages.payout')  }}</a>
