...
@section('main_content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Spam</li>       
         </ol>
    </nav>
     <!-- The Modal -->
        ...
        <small>Send A Template</small>      </button> --}}
            ...
            <div class="card mt-2">
                ...
                <div class="card-body card-padding">
                    ...
                    <li class="list-group-item bg-transparent text-dark">
                        <a href="{{ route('vendor.message.spams_message') }}" class="liAct"><i class="fa fa-filter"></i>
                            Spam</a>
                    </li>
                    <li class="list-group-item bg-transparent text-dark">
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-btn").click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.message.spams_spams_data') }}",
                        type: "POST",
            ...
            $(function() {
                $.fn.tableload = function() {
                    $('#review_table').dataTable({
                        ...
                        "ajax": {
                            url: "{{ route('vendor.message.message_data_spam') }}",
                            "type": "POST",
                            "data": function(d) {
                                d._token = "{{ csrf_token() }}";
                            },
