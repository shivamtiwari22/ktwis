        ...
        <small>Send A Template</small>      </button> --}}
            ...
            <div class="card mt-2">
                <div class="card-body card-padding">
                    ...
                    <li class="list-group-item bg-transparent text-dark">
                        <a href="{{ route('vendor.message.sent_message') }}" class="liAct"><i class="fa fa-envelope-o"></i>
                            Sent</a>
                    </li>
                    <li class="list-group-item bg-transparent text-dark">
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-trash").click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.message.sent_trash_data') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-btn").click(function() {
                    ...
                    // alert(formData);
                    $.ajax({
                        url: "{{ route('vendor.message.sent_spams_data') }}",
                        type: "POST",
            ...
            $(function() {
                $.fn.tableload = function() {
                    $('#review_table').dataTable({
                        ...
                        "ajax": {
                            url: "{{ route('vendor.message.message_data_sent') }}",
                            "type": "POST",
                            "data": function(d) {
                                d._token = "{{ csrf_token() }}";
                            },
