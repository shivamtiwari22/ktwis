        ...
        <small>Send A Template</small>      </button> --}}
            ...
            <div class="card mt-2">
                ...
                <div class="card-body card-padding">
                    ...
                    <li class="list-group-item bg-transparent text-dark">
                        <a href="{{ route('vendor.message.draft_message') }}" class=""><i
                                class="fa fa-file-text-o"></i> Drafts</a>
                    </li>
                    <li class="list-group-item bg-transparent text-dark">
                        <a href="{{ route('vendor.message.spams_message') }}" class=""><i class="fa fa-filter"></i>
                            Spam</a>
                    </li>
                    <li class="list-group-item bg-transparent text-dark">
                        <a href="{{ route('vendor.message.trash_message') }}" class="liAct"><i class="fa fa-trash-o"></i>
                            Trash</a>
                    </li>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="dropdown mb-3">
                            ...
                            <ul class="dropdown-menu ">
                                <li>
                                    <p class="white-link mydata" id="submit-btn"><i class="fa fa-inbox icon"></i> Move to
                                        inbox</p>
                                </li>
                                <hr>
                                <li>
                                    <p class="white-link mydata" id='submit-trash'><i class="fa fa-trash-o icon"></i> Delete
                                        permanently</p>
                                </li>
                            </ul>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-trash").click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.message.spam_data_delete') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-btn").click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.message.trash_spams_data') }}",
                        type: "POST",
            ...
            $(function() {
                $.fn.tableload = function() {
                    $('#review_table').dataTable({
                        ...
                        "ajax": {
                            url: "{{ route('vendor.message.trash_message_data_spam') }}",
                            "type": "POST",
                            "data": function(d) {
                                d._token = "{{ csrf_token() }}";
                            },
