        ...
        <div class="modal-content">
            ...
            <form id="reply_form">
                ...
                <div>
                    ...
                    <select name="customer" class="form-control select2" id="customerDropdown">
            ...
            <div class="card mt-2">
                ...
                <div class="card-body card-padding">
                    ...
                    <li class="list-group-item bg-transparent text-dark">
                        <a href="#" class="liAct"><i class="fa fa-inbox"></i> Inbox</a>
                    </li>
                    <li class="list-group-item bg-transparent text-dark">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="dropdown mb-3">
                            ...
                            <ul class="dropdown-menu " >
                                <li>
                                    <p class="white-link mydata" id="submit-btn"><i class="fa fa-filter icon"></i> Spam
                                    </p>
                                </li>
                                <hr>
                                <li>
                                    <p class="white-link mydata" id='submit-trash'><i class="fa fa-trash-o icon"></i>
                                        Trash
                                    </p>
                                </li>
                            </ul>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-trash").click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.message.trash_data') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-btn").click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.message.spams_data') }}",
                        type: "POST",
            ...
            $(function() {
                $.fn.tableload = function() {
                    $('#review_table').dataTable({
                        ...
                        "ajax": {
                            url: "{{ route('vendor.message.message_data') }}",
                            "type": "POST",
                            "data": function(d) {
                                d._token = "{{ csrf_token() }}";
                            },
