...
<h2>Edit <span class="badge badge-success-lighten">Tax</span></h2>
<hr>
    ...
    <form id="coupon_form">
        <div class="row">
            ...
            <div class="mb-3 col-lg-6">
                ...
                <input id="tax_rate" type="number" class="form-control @error('tax_rate') is-invalid @enderror" name="tax_rate" placeholder="Tax Rate %" min="1" value="{{ $tax->tax_rate }}">
                @error('tax_rate')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
